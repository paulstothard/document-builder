...
python3 document-builder.py dropbox -c sample-project/config/config.json -v
...
python3 document-builder.py dropbox -c sample-project-assignment/config/config.json -a -v
