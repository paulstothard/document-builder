...
python document-builder.py -p sample-project-import -v

# import data into project
echo "Importing data into project from sample-import-data"
python document-builder.py -c sample-project-import/config/config.json -v -m sample-import-data

# process the project as usual
echo "Processing project"
python document-builder.py -c sample-project-import/config/config.json -v